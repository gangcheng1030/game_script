...
const (
	...
	MEIRI_TYPE_SHENGDIXUNLI      MeiRiType = "sdxl"
)
...
func (c *chaoJiDou) MeiRiTiaoZhan(mt MeiRiType, dt DifficultyType) {
	...
	if mt == MEIRI_TYPE_HEWEIANYING {
		...
		c.huozhijidian()
	} else if mt == MEIRI_TYPE_SHENGDIXUNLI {
		c.shengdixunli()
	}
...
func (c *chaoJiDou) shengdixunli() {
	// 开始战斗
	c.clickButton(c.StartBattleButton, 13)

	c.dayangshouhuzheMeiri()
	c.qiuzhuxinhaoMeiri()
	c.mengmamudiMeiri()
	c.dunyueshengdiMeiri()
}
...
func (c *chaoJiDou) shenhaiyizuMeiri() {
	...
	// 第1张怪物图
	c.clickButtonWithAlt(fuben.SmallMap[0], 8)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.Key3, 2)
	...
	// 第2张怪物图
	c.clickButtonWithAlt(fuben.SmallMap[1], 8)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.Key3, 2)
	...
	// 第4张怪物图
	c.clickButtonWithAlt(fuben.SmallMap[3], 8)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.Key3, 2)
	...
	// 第5张怪物图
	c.clickButtonWithAlt(fuben.SmallMap[4], 8)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.Key3, 2)
	c.move(1027, 245, 1, 3)
	robotgo.Sleep(8)
	...
	// 第6张怪物图
	c.clickButtonWithAlt(fuben.SmallMap[5], 5)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.Key3, 2)
	...
	// 第7张怪物图
	c.clickButtonWithAlt(fuben.SmallMap[6], 5)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.Key3, 2)
	c.move(362, 161, 1, 3)
	c.press(robotgo.KeyD, 1)
	...
	// 第8张怪物图： boss
	c.clickButtonWithAlt(fuben.SmallMap[7], 8)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.KeyD, 1)
...
func (c *chaoJiDou) shijunzhizuiMeiri() {
	...
	// 第3张怪物图
	c.clickButtonWithAlt(fuben.SmallMap[2], 5)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.Key3, 2)
	c.move(1023, 64, 1, 3)
	c.press(robotgo.KeyD, 1)
	...
	// 第5张怪物图
	c.clickButtonWithAlt(fuben.SmallMap[4], 5)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.Key3, 2)
...
func (c *chaoJiDou) tongxiangweiyijieMeiri() {
	...
	// 第4张怪物图
	c.clickButtonWithAlt(fuben.SmallMap[3], 11)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.Key3, 2)
	robotgo.Sleep(12)
	...
	// 第6张怪物图： boss
	c.clickButtonWithAlt(fuben.SmallMap[5], 8)
	c.press(robotgo.KeyT, 1)
	c.press(robotgo.KeyT, 1)
	c.press(robotgo.KeyT, 1)
	c.press(robotgo.KeyT, 1)
...
func (c *chaoJiDou) yexinzhongheMeiri() {
	...
	// 第2张怪物图
	c.clickButtonWithAlt(fuben.SmallMap[1], 6)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.Key3, 2)
...
func (c *chaoJiDou) fengyinzhishiMeiri() {
	...
	// 第1张怪物图
	c.clickButtonWithAlt(fuben.SmallMap[0], 8)
	robotgo.MoveSmooth(181+c.GameWindow.X, 571+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.Key3, 2)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(8)
	...
	// 第2张怪物图
	c.clickButtonWithAlt(fuben.SmallMap[1], 8)
	robotgo.MoveSmooth(70+c.GameWindow.X, 307+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.Key3, 2)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(8)
	...
	// 第3张怪物图
	c.clickButtonWithAlt(fuben.SmallMap[2], 8)
	robotgo.MoveSmooth(1078+c.GameWindow.X, 628+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.Key3, 2)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(8)
	...
	// 第4张怪物图
	c.clickButtonWithAlt(fuben.SmallMap[3], 8)
	robotgo.MoveSmooth(1135+c.GameWindow.X, 401+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.Key3, 2)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(8)
	...
	// 第5张怪物图
	c.clickButtonWithAlt(fuben.SmallMap[4], 11)
	robotgo.MoveSmooth(1119+c.GameWindow.X, 271+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.Key3, 2)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(8)
	...
	// 第6张怪物图
	c.clickButtonWithAlt(fuben.SmallMap[5], 11)
	robotgo.MoveSmooth(1149+c.GameWindow.X, 273+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.Key3, 2)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(8)
	...
	// 第7张怪物图： boss
	c.clickButtonWithAlt(fuben.SmallMap[6], 10)
	robotgo.MoveSmooth(1079+c.GameWindow.X, 221+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.KeyD, 1)
...
func (c *chaoJiDou) yingxiongdezigeMeiri() {
	...
	// 第1张怪物图
	c.clickButtonWithAlt(fuben.SmallMap[0], 8)
	robotgo.MoveSmooth(533+c.GameWindow.X, 139+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.Key3, 2)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(8)
	...
	// 第2张怪物图
	c.clickButtonWithAlt(fuben.SmallMap[1], 10)
	robotgo.MoveSmooth(188+c.GameWindow.X, 459+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.Key3, 2)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(6)
	...
	// 第3张怪物图
	c.clickButtonWithAlt(fuben.SmallMap[2], 8)
	robotgo.MoveSmooth(18+c.GameWindow.X, 170+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.Key3, 2)
	c.move(18, 170, 1, 5)
	c.press(robotgo.KeyD, 1)
	...
	// 第4张怪物图
	c.clickButtonWithAlt(fuben.SmallMap[3], 5)
	robotgo.MoveSmooth(118+c.GameWindow.X, 216+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.Key3, 2)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(8)
	...
	// 第5张怪物图
	c.clickButtonWithAlt(fuben.SmallMap[4], 8)
	robotgo.MoveSmooth(76+c.GameWindow.X, 618+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.Key3, 2)
...
func (c *chaoJiDou) tianheMeiri() {
	...
	// 第4张怪物图
	c.clickButtonWithAlt(fuben.SmallMap[3], 6)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.Key3, 2)
	...
	// 第5张怪物图
	c.clickButtonWithAlt(fuben.SmallMap[4], 6)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.Key3, 2)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(8)
...
func (c *chaoJiDou) tiankongdapingyuanMeiri() {
	...
	// 第6张怪物图
	c.clickButtonWithAlt(fuben.SmallMap[5], 6)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.Key3, 2)
	c.move(675, 54, 1, 5)
	robotgo.MoveSmooth(575+c.GameWindow.X, 54+c.GameWindow.Y, mouseSpeedX, mouseSpeedY)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(4)

	// 第7张怪物图： boss
	c.clickButtonWithAlt(fuben.SmallMap[6], 13)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.KeyD, 1)
...
func (c *chaoJiDou) xunnanguangchangrukouMeiri() {
	...
	// 第2张怪物图
	c.clickButtonWithAlt(fuben.SmallMap[1], 14)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.Key3, 2)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(8)
	...
	// 第3张怪物图
	c.clickButtonWithAlt(fuben.SmallMap[2], 10)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.Key3, 2)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(8)
	...
	// 第6张怪物图： boss
	c.clickButtonWithAlt(fuben.SmallMap[5], 7)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.KeyD, 1)
...
func (c *chaoJiDou) bangongxiuxishiMeiri() {
	...
	// 第7张怪物图
	c.clickButtonWithAlt(fuben.SmallMap[6], 8)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.Key3, 2)
	c.move(1022, 80, 2, 5)
	c.press(robotgo.KeyD, 1)
...
func (c *chaoJiDou) zhongjibingqiMeiri() {
	...
	// 第4张怪物图
	c.clickButtonWithAlt(fuben.SmallMap[3], 10)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.Key3, 2)
	c.move(79, 77, 2, 5)
	c.press(robotgo.KeyD, 1)
...
func (c *chaoJiDou) quanjianzuozhanMeiri() {
	...
	// 第1张怪物图
	c.clickButtonWithAlt(fuben.SmallMap[0], 15)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.Key3, 2)
	...
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.Key3, 2)
	robotgo.MoveSmooth(581+c.GameWindow.X, 123+c.GameWindow.Y, mouseSpeedX, mouseSpeedY)
	c.press(robotgo.KeyT, 4)
	c.multiMove(481, 123, 1, 1, 5)
	robotgo.Sleep(3)
	c.press(robotgo.KeyD, 1)
	c.multiMove(650, 123, 1, 1, 4)
	robotgo.Sleep(6)
	...
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.Key3, 2)
	c.multiMove(681, 69, 1, 1, 1)
	robotgo.Sleep(3)
	c.press(robotgo.KeyD, 1)
	robotgo.MoveSmooth(690+c.GameWindow.X, 80+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(3)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(3)
...
func (c *chaoJiDou) qtshamokaifabuMeiri() {
	...
	robotgo.Sleep(3)
	robotgo.MoveSmooth(1216+c.GameWindow.X, 140+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
...
func (c *chaoJiDou) tiankongzhizuanMeiri() {
	...
	robotgo.MoveSmooth(1153+c.GameWindow.X, 164+c.GameWindow.Y, 0.9, 0.9)
...
func (c *chaoJiDou) bingheMeiri() {
	...
	c.press(robotgo.Key3, 2)
	c.move(1075, 156, 3, 4)
	robotgo.MoveSmooth(1065+c.GameWindow.X, 156+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(5)
	...
	c.press(robotgo.Key3, 2)
	c.move(1277, 268, 3, 4)
	robotgo.MoveSmooth(1267+c.GameWindow.X, 268+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(5)
	...
	robotgo.Sleep(3)
	robotgo.MoveSmooth(1248+c.GameWindow.X, 437+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(5)
	...
	robotgo.Sleep(3)
	robotgo.MoveSmooth(725+c.GameWindow.X, 49+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(5)

	// 第6张怪物图： boss
	c.clickButtonWithAlt(fuben.SmallMap[4], 7)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.KeyD, 1)
...
func (c *chaoJiDou) bingxuebuluomubacunMeiri() {
	...
	c.press(robotgo.Key3, 2)
	c.move(733, 56, 3, 4)
	robotgo.MoveSmooth(722+c.GameWindow.X, 46+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(5)
	...
	c.press(robotgo.Key3, 2)
	c.move(688, 37, 3, 5)
	robotgo.MoveSmooth(678+c.GameWindow.X, 37+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(6)
	...
	c.press(robotgo.Key3, 2)
	c.move(702, 76, 3, 4)
	robotgo.MoveSmooth(692+c.GameWindow.X, 76+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(6)
	...
	c.press(robotgo.Key3, 2)
	c.move(340, 181, 3, 4)
	robotgo.MoveSmooth(330+c.GameWindow.X, 181+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(6)
...
func (c *chaoJiDou) buguixiaguMeiri() {
	...
	c.press(robotgo.Key3, 2)
	c.move(1145, 184, 3, 4)
	robotgo.MoveSmooth(1135+c.GameWindow.X, 184+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(6)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(5)
	...
	robotgo.Sleep(3)
	robotgo.MoveSmooth(1309+c.GameWindow.X, 279+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(6)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(5)
	...
	c.press(robotgo.Key3, 2)
	c.move(867, 164, 3, 4)
	robotgo.MoveSmooth(857+c.GameWindow.X, 164+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(6)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(5)
	...
	c.press(robotgo.Key3, 2)
	c.move(1002, 154, 3, 4)
	robotgo.MoveSmooth(992+c.GameWindow.X, 154+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(6)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(3)
...
func (c *chaoJiDou) bingfengchengbaoMeiri() {
	...
	c.press(robotgo.Key3, 2)
	c.move(258, 46, 3, 4)
	robotgo.MoveSmooth(248+c.GameWindow.X, 46+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(6)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(6)
	...
	c.press(robotgo.Key3, 2)
	c.move(1146, 126, 3, 4)
	robotgo.MoveSmooth(1136+c.GameWindow.X, 126+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(6)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(6)
	...
	c.press(robotgo.Key3, 2)
	c.move(204, 80, 3, 4)
	robotgo.MoveSmooth(194+c.GameWindow.X, 80+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(6)
	...
	c.press(robotgo.Key3, 2)
	c.move(157, 110, 3, 4)
	robotgo.MoveSmooth(147+c.GameWindow.X, 110+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(6)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(6)
	...
	c.press(robotgo.Key3, 2)
	c.move(68, 278, 3, 4)
	robotgo.MoveSmooth(58+c.GameWindow.X, 278+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(6)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(6)
...
func (c *chaoJiDou) jianruixiaguMeiri() {
	...
	c.press(robotgo.Key3, 2)
	c.move(781, 150, 3, 4)
	robotgo.MoveSmooth(681+c.GameWindow.X, 150+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(6)
	c.move(28, 70, 3, 4)
	c.press(robotgo.KeyD, 1)
	...
	c.press(robotgo.Key3, 2)
	c.move(63, 639, 3, 4)
	robotgo.MoveSmooth(53+c.GameWindow.X, 639+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(6)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(8)
	...
	c.press(robotgo.Key3, 2)
	c.move(231, 83, 3, 4)
	robotgo.MoveSmooth(131+c.GameWindow.X, 83+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(6)
	c.move(254, 83, 3, 4)
	c.press(robotgo.KeyD, 1)
	...
	c.press(robotgo.Key3, 2)
	c.move(763, 56, 3, 4)
	robotgo.MoveSmooth(663+c.GameWindow.X, 56+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(6)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(8)
	...
	c.press(robotgo.Key3, 2)
	c.move(1138, 49, 3, 4)
	robotgo.MoveSmooth(1038+c.GameWindow.X, 49+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(6)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(8)
	...
	c.press(robotgo.Key3, 2)
	c.move(1274, 340, 3, 4)
	robotgo.MoveSmooth(1174+c.GameWindow.X, 340+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(6)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(5)
	...
	robotgo.Sleep(4)
	c.move(1185, 213, 3, 4)
	robotgo.MoveSmooth(1085+c.GameWindow.X, 213+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(4)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(4)
...
func (c *chaoJiDou) yueguangdadaoMeiri() {
	...
	robotgo.Sleep(4)
	c.move(1198, 164, 3, 4)
	robotgo.MoveSmooth(1098+c.GameWindow.X, 164+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(3)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(3)
	...
	robotgo.Sleep(4)
	c.move(1093, 114, 3, 4)
	robotgo.MoveSmooth(993+c.GameWindow.X, 114+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(3)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(3)
	...
	robotgo.Sleep(4)
	robotgo.MoveSmooth(477+c.GameWindow.X, 37+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(3)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(3)
	...
	robotgo.Sleep(4)
	c.move(1174, 93, 3, 4)
	robotgo.MoveSmooth(1074+c.GameWindow.X, 93+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(3)
	...
	// 第5张怪物图
	c.clickButtonWithAlt(fuben.SmallMap[4], 10)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.Key3, 2)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(11)
	...
	// 第6张怪物图： boss
	c.clickButtonWithAlt(fuben.SmallMap[5], 10)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.KeyD, 1)
...
func (c *chaoJiDou) shixianzhengyiMeiri() {
	...
	c.press(robotgo.Key3, 2)
	c.move(223, 130, 1, 4)
	robotgo.MoveSmooth(123+c.GameWindow.X, 130+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(3)
	c.move(1150, 153, 1, 6)
	robotgo.MoveSmooth(1050+c.GameWindow.X, 153+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(3)
	c.move(1010, 261, 1, 6)
	robotgo.MoveSmooth(910+c.GameWindow.X, 261+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(6)
	...
	robotgo.MoveSmooth(104+c.GameWindow.X, 77+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(3)
	c.multiMove(204, 77, 1, 1, 5)
	robotgo.MoveSmooth(104+c.GameWindow.X, 77+c.GameWindow.Y, 0.9, 0.9)
	...
	c.press(robotgo.Key3, 2)
	c.move(35, 311, 3, 4)
	robotgo.MoveSmooth(25+c.GameWindow.X, 311+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(5)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(5)
	...
	c.press(robotgo.Key3, 2)
	c.move(218, 629, 3, 4)
	robotgo.MoveSmooth(118+c.GameWindow.X, 629+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(5)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(5)
...
func (c *chaoJiDou) shijiantingyuanMeiri() {
	...
	// 第6张怪物图
	c.clickButtonWithAlt(fuben.SmallMap[5], 12)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.Key3, 2)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(4)
...
func (c *chaoJiDou) huweiduixiongmeiMeiri() {
	...
	c.press(robotgo.Key3, 2)
	c.move(1021, 72, 3, 4)
	robotgo.MoveSmooth(1221+c.GameWindow.X, 72+c.GameWindow.Y, 0.9, 0.9)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(4)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(4)
...
func (c *chaoJiDou) qingzhulinMeiri() {
	...
	// 第8张怪物图： boss
	c.clickButtonWithAlt(fuben.SmallMap[7], 6)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(2)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(2)
...
func (c *chaoJiDou) beimangshanMeiri() {
	...
	// 第4张怪物图
	c.clickButtonWithAlt(fuben.SmallMap[3], 13)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.Key3, 2)
	c.move(1091, 120, 3, 4)
	c.press(robotgo.KeyD, 1)
...
func (c *chaoJiDou) kongzhonganxiMeiri() {
	...
	c.press(robotgo.Key3, 2)
	c.move(1148, 52, 3, 3)
	robotgo.MoveSmooth(1148+c.GameWindow.X, 152+c.GameWindow.Y, mouseSpeedX, mouseSpeedY)
	c.press(robotgo.KeyD, 1)
	c.move(1148, 52, 3, 3)
	robotgo.MoveSmooth(1148+c.GameWindow.X, 152+c.GameWindow.Y, mouseSpeedX, mouseSpeedY)
	c.press(robotgo.KeyD, 1)
...
func (c *chaoJiDou) dixiatingchechangMeiri() {
	...
	c.press(robotgo.Key3, 2)
	c.move(430, 51, 3, 4)
	robotgo.MoveSmooth(430+c.GameWindow.X, 151+c.GameWindow.Y, mouseSpeedX, mouseSpeedY)
	c.press(robotgo.KeyD, 1)
	c.move(430, 51, 3, 4)
	robotgo.MoveSmooth(430+c.GameWindow.X, 151+c.GameWindow.Y, mouseSpeedX, mouseSpeedY)
	c.press(robotgo.KeyD, 1)
	...
	robotgo.Sleep(3)
	robotgo.MoveSmooth(72+c.GameWindow.X, 446+c.GameWindow.Y, mouseSpeedX, mouseSpeedY)
	c.press(robotgo.KeyD, 1)
	...
	robotgo.Sleep(3)
	robotgo.MoveSmooth(261+c.GameWindow.X, 457+c.GameWindow.Y, mouseSpeedX, mouseSpeedY)
	c.press(robotgo.KeyD, 1)
	c.move(261, 357, 3, 4)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(4)
...
func (c *chaoJiDou) nizongshensheshouMeiri() {
	...
	robotgo.Sleep(2)
	robotgo.MoveSmooth(278+c.GameWindow.X, 238+c.GameWindow.Y, mouseSpeedX, mouseSpeedY)
	c.press(robotgo.KeyD, 1)
	c.multiMove(278, 138, 1, 1, 6)
	robotgo.Sleep(2)
	c.press(robotgo.KeyD, 1)
...
func (c *chaoJiDou) dixiajidishiyanshiMeiri() {
	...
	robotgo.MoveSmooth(702+c.GameWindow.X, 34+c.GameWindow.Y, mouseSpeedX, mouseSpeedY)
	c.press(robotgo.KeyT, 1)
	c.press(robotgo.KeyT, 1)
	c.press(robotgo.KeyT, 1)
	c.press(robotgo.KeyT, 4)
...
func (c *chaoJiDou) yishengyuzhaozeMeiri() {
	...
	// 第7张怪物图： boss
	c.clickButtonWithAlt(fuben.SmallMap[6], 11)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.KeyD, 1)
...
func (c *chaoJiDou) shaleduonaihuoshankouMeiri() {
	...
	robotgo.MoveSmooth(670+c.GameWindow.X, 94+c.GameWindow.Y, mouseSpeedX, mouseSpeedY)
	for i := 0; i < 7; i++ {
		c.press(robotgo.KeyD, 5)
	}
...
func (c *chaoJiDou) zhuqiaoMeiri() {
	...
	c.press(robotgo.Key3, 2)
	c.move(270, 80, 3, 4)
	robotgo.MoveSmooth(270+c.GameWindow.X, 180+c.GameWindow.Y, mouseSpeedX, mouseSpeedY)
	c.press(robotgo.KeyD, 1)
	c.move(270, 80, 3, 4)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(4)
...
func (c *chaoJiDou) youlingcangkuMeiri() {
	...
	// 第7张怪物图： boss
	c.clickButtonWithAlt(fuben.SmallMap[6], 7)
	robotgo.Sleep(18)
...
func (c *chaoJiDou) dixiajidizuizhongjuezhanMeiri() {
	...
	c.press(robotgo.Key3, 2)
	c.move(1172, 87, 3, 4)
	robotgo.MoveSmooth(1172+c.GameWindow.X, 187+c.GameWindow.Y, mouseSpeedX, mouseSpeedY)
	c.press(robotgo.KeyD, 1)
	c.move(952, 53, 3, 4)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(6)
...
func (c *chaoJiDou) zaicimianduiweixianMeiri() {
	...
	// 第8张怪物图
	c.clickButtonWithAlt(fuben.SmallMap[7], 3)
	c.multiMove(148, 182, 1, 1, 18)
	robotgo.Sleep(2)

	// 第9张怪物图
	c.clickButtonWithAlt(fuben.SmallMap[8], 5)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.Key3, 1)
	c.move(949, 126, 3, 4)
	c.press(robotgo.KeyD, 1)
	...
	// 第10张怪物图
	c.clickButtonWithAlt(fuben.SmallMap[9], 3)
	c.multiMove(1168, 337, 1, 1, 18)
	robotgo.Sleep(2)

	// 第11张怪物图： boss
	c.clickButtonWithAlt(fuben.SmallMap[10], 5)
	robotgo.Sleep(15)
...
func (c *chaoJiDou) heimeiguitingyuanMeiri() {
	...
	// 第6张怪物图： boss
	c.clickButtonWithAlt(fuben.SmallMap[5], 4)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(15)
...
func (c *chaoJiDou) bolizhidiMeiri() {
	...
	// 第2张怪物图
	c.clickButtonWithAlt(fuben.SmallMap[1], 11)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.Key3, 2)
	c.move(1014, 44, 3, 4)
	c.press(robotgo.KeyD, 1)
...
func (c *chaoJiDou) senlinbianjieMeiri() {
	...
	// 第2张怪物图
	c.clickButtonWithAlt(fuben.SmallMap[1], 5)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.Key3, 2)
	c.move(1159, 59, 3, 4)
	c.press(robotgo.KeyD, 1)
...
func (c *chaoJiDou) denglulalaiyeMeiri() {
	...
	// 第8张怪物图： boss
	c.clickButtonWithAlt(fuben.SmallMap[7], 10)
	robotgo.Sleep(20)
...
func (c *chaoJiDou) luosudedixiashijieMeiri() {
	...
	// 第6张怪物图
	c.clickButtonWithAlt(fuben.SmallMap[5], 3)
	c.clickButtonWithAlt(fuben.SmallMap[5], 3)
	c.clickButtonWithAlt(fuben.SmallMap[5], 6)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.Key3, 2)
	...
	// 第7张怪物图: boss
	for i := 0; i < 11; i++ {
		c.clickButtonWithAlt(fuben.SmallMap[6], 3)
	}
}
...
func (c *chaoJiDou) haishangqiaoliangMeiri() {
	...
	robotgo.Sleep(2)
	robotgo.MoveSmooth(1095+c.GameWindow.X, 209+c.GameWindow.Y, mouseSpeedX, mouseSpeedY)
	c.press(robotgo.KeyD, 1)
	c.multiMove(1095, 109, 1, 1, 3)
	robotgo.Sleep(2)
	c.press(robotgo.KeyD, 1)
...
func (c *chaoJiDou) heihaiMeiri() {
	...
	robotgo.Sleep(2)
	robotgo.MoveSmooth(1255+c.GameWindow.X, 501+c.GameWindow.Y, mouseSpeedX, mouseSpeedY)
	c.press(robotgo.KeyD, 1)
...
func (c *chaoJiDou) langzimoluMeiri() {
	...
	robotgo.Sleep(2)
	robotgo.MoveSmooth(1250+c.GameWindow.X, 250+c.GameWindow.Y, mouseSpeedX, mouseSpeedY)
	c.press(robotgo.KeyD, 1)
	c.move(100, 100, 1, 3)
	c.press(robotgo.KeyD, 1)
	robotgo.Sleep(4)
...
func (c *chaoJiDou) xunzhaochuluMeiri() {
	...
	// 第9张怪物图
	c.clickButtonWithAlt(fuben.SmallMap[8], 8)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.Key3, 2)
	robotgo.Sleep(3)
	c.move(1014, 117, 3, 4)
	...
	// 第10张怪物图: boss
	c.clickButtonWithAlt(fuben.SmallMap[9], 8)
	robotgo.Sleep(20)
...
func (c *chaoJiDou) huoyanzhinvMeiri() {
	...
	// 第5张怪物图
	c.clickButtonWithAlt(fuben.SmallMap[4], 3)
	c.clickButtonWithAlt(fuben.SmallMap[4], 3)
	c.clickButtonWithAlt(fuben.SmallMap[4], 8)
	c.press(robotgo.KeyD, 1)
	c.press(robotgo.Key3, 2)
...
func (c *chaoJiDou) dayangshouhuzheMeiri() {
	fuben := c.JuQingMap.FuBens[c.MeiRiMap.ShengDiXunLi[0]]
	c.prestart()
...
func (c *chaoJiDou) qiuzhuxinhaoMeiri() {
	fuben := c.JuQingMap.FuBens[c.MeiRiMap.ShengDiXunLi[1]]
	c.prestart()
	...
	c.press(robotgo.KeyT, 4)
	c.clickButtonWithAlt(fuben.SmallMap[6], 8)
	c.multiMove(76, 509, 1, 1, 5)
	robotgo.MoveSmooth(1101+c.GameWindow.X, 145+c.GameWindow.Y, mouseSpeedX, mouseSpeedY)
	for i := 0; i < 9; i++ {
		c.press(robotgo.KeyD, 1)
		robotgo.Sleep(4)
	}
...
func (c *chaoJiDou) mengmamudiMeiri() {
	fuben := c.JuQingMap.FuBens[c.MeiRiMap.ShengDiXunLi[2]]
	c.prestart()
...
func (c *chaoJiDou) dunyueshengdiMeiri() {
	fuben := c.JuQingMap.FuBens[c.MeiRiMap.ShengDiXunLi[3]]
	c.prestart()
	...
	c.clickButtonWithAlt(fuben.SmallMap[9], 8)
	for i := 0; i < 10; i++ {
		c.multiMove(100, 100, 1, 1, 10)
		c.press(robotgo.Key3, 2)
		c.multiMove(1237, 100, 1, 1, 10)
		c.move(363, 617, 1, 3)
	}
}
